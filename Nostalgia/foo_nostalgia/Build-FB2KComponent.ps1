...
.DESCRIPTION
    ...
    then creates a dual-arch .fb2k-component package layout:
      root = Win32 files
      x64/ = x64 files
    Package output: <project_dir>\..\out\<TargetName>.fb2k-component
#>
...
$extraCommon = @(
'3rdParty\\SkaleTracker\\SkalePlayer\\Bin\\Win32\\SkalePlayer.dll',
'3rdParty\\libksnd-windows-x86\\x86\\release\\ksnd.dll',
'3rdParty\\libksnd-windows-x86\\x86\\release\\libksnd.dll'
)
$extraX64 = @(
