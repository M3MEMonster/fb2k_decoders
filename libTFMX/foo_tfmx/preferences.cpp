...
class CTFMXPrefs : public CDialogImpl<CTFMXPrefs>, public preferences_page_instance {
public:
    enum { IDD = IDD_TFMX_PREFS };
    CTFMXPrefs(preferences_page_callback::ptr cb) : m_cb(cb) {}
...
private:
    BOOL OnInit(CWindow, LPARAM) {
        ...
        LVCOLUMN col{}; col.mask = LVCF_WIDTH | LVCF_TEXT; col.cx = 310; col.pszText = const_cast<LPWSTR>(L"Format");
